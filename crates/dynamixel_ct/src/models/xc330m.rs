//! Dynamixel XC330M model definitions.
...
model![XC330M => {
    ...
    Led: 65, 1, Access::Rw, Area::Ram, None,
    ...
    GoalCurrent: 102, 2, Access::Rw, Area::Ram, Some(UnitScale::new(Unit::Ampere, 0.001f32)),
    ...
    PresentPwm: 124, 2, Access::R, Area::Ram, Some(UnitScale::new(Unit::Percent, 0.113f32)),
    PresentCurrent: 126, 2, Access::R, Area::Ram, Some(UnitScale::new(Unit::Ampere, 0.001f32)),
    ...
    PwmSlope: 62, 1, Access::Rw, Area::Eeprom, Some(UnitScale::new(Unit::VoltPerSecond, 1.977f32)),
}];
