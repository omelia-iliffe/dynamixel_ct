...
model![XH430V => {
    ...
    CurrentLimit: 38, 2, Access::Rw, Area::Eeprom, Some(UnitScale::new(Unit::Ampere, 0.00134f32)),
    ...
    GoalCurrent: 102, 2, Access::Rw, Area::Ram, Some(UnitScale::new(Unit::Ampere, 0.00134f32)),
    ...
    PresentCurrent: 126, 2, Access::R, Area::Ram, Some(UnitScale::new(Unit::Ampere, 0.00134f32)),
